...
export default class Exercice_12_Intro extends React.Component {
  constructor(props) {
    super(props);
        ...
        <ScrollView>
          <View style={styles.container_scroll_img_absolute}>
            ...
            <View style={styles.middle}>
              <Text style={styles.intro_header_day_light}>Day 12</Text>
              <Text style={styles.intro_header_light}>Inner Scientist</Text>
              ...
              In this exercise, you will discover a new way to handle impulses that drive you to use the smartphone unconsciously.{" "}
              </Text>
