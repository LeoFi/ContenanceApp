...
export default class Exercice_17_Challenge extends React.Component {
  constructor(props) {
    super(props);
        ...
        <ScrollView>
          <View style={{ flex: 1 }}>
            <TouchableWithoutFeedback
              style={styles.scroll}
              onPress={() => {
                this.props.navigation.navigate("Exercice_17_Congratulations");
              }}
            >
              <View style={styles.container_scroll}>
                ...
                <Text style={styles.text}>
                  ...
                  {"\n"}{"\n"}Now put it into action. Right now. See how it changes your behavior. If you are brave, do all three of them now.
                </Text>
