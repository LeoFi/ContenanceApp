...
class Exercice_11_Intro extends React.Component {
  constructor(props) {
    super(props);
            ...
            <View style={styles.container_scroll_img_absolute}>
              ...
              <View style={styles.middle}>
                ...
                <Text style={styles.intro_text_light}>
                  {"\n"}5 MIN{"\n"}In this exercise, you will discover a playful
                  trick to connect back with your surroundings if you got lost
                  in your smartphone.
                </Text>
              </View>
            </View>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  Before learning this trick, explore which are the apps you tend to get lost in. Enjoy!
                  </Text>
                  <ExerciceButton
                    onPress={() => {
                      {
...
export default connect(mapStateToProps)(Exercice_11_Intro);
