...
class WB_Screen_T2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show_1: true,
  ...
  getChecked = value => {
    ...
    setTimeout(() => {
      if (this.state.show_1 == true) {
        ...
        this.setState({ progressValueT2: 10 / 60 });
      } else if (this.state.show_2 == true) {
        this.setState({ show_1: false });
        this.setState({ show_2: false });
        this.setState({ show_3: true });
        this.setState({ progressValueT2: 11 / 60 });
      } else if (this.state.show_3 == true) {
        this.setState({ show_1: false });
        this.setState({ show_2: false });
        this.setState({ show_3: false });
        this.setState({ show_4: true });
        this.setState({ progressValueT2: 12 / 60 });
        ...
        this.setState({ progressValueT2: 13 / 60 });
        ...
        this.setState({ progressValueT2: 14 / 60 });
        ...
        this.setState({ progressValueT2: 15 / 60 });
        ...
        this.setState({ progressValueT2: 16 / 60 });
        ...
        this.setState({ progressValueT2: 17 / 60 });
        ...
        this.setState({ progressValueT2: 18 / 60 });
        ...
        this.setState({ progressValueT2: 19 / 60 });
        ...
        this.setState({ progressValueT2: 20 / 60 });
        ...
        this.setState({ progressValueT2: 21 / 60 });
        ...
        this.setState({ progressValueT2: 22 / 60 });
        ...
        this.setState({ progressValueT2: 23 / 60 });
        ...
        this.setState({ progressValueT2: 24 / 60 });
        ...
        this.setState({ progressValueT2: 25 / 60 });
        ...
        this.setState({ progressValueT2: 26 / 60 });
        ...
        this.setState({ progressValueT2: 27 / 60 });
        ...
        this.setState({ progressValueT2: 28 / 60 });
        ...
        this.setState({ progressValueT2: 29 / 60 });
      } else if (this.state.show_21 == true) {
        this.setState({ buttonIsActive: true });
        this.setState({ progressValueT2: 30 / 60 });
      }
    }, 400);
  };
      ...
      <>
        ...
        <View style={styles.container}>
          ...
          {this.state.show_1 ? (
            <>
              <Text style={styles.text_left}>
                How much of the time did you feel you were making progress
          ...
          {this.state.show_18 ? (
            <>
              <Text style={styles.text_left}>
                To what extent did you generally feel you had a sense of
...
export default connect(mapStateToProps)(WB_Screen_T2);
