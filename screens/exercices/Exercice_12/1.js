...
export default class Exercice_12_1 extends Component {
  constructor(props) {
    super(props);
  ...
  async _loadNewPlaybackInstance(playing) {
    ...
    const source = require("../../../assets/sounds/TheInnerScientist_DAY_12.mp3");
      ...
      return (
        <Svg width="79" height="79" viewBox="0 0 79 79" fill="none">
          <Circle
            ...
            stroke-width="4"
          />
          <Circle cx="39.5" cy="39.5" r="35.5" fill="#FDFDF7" />
          <Path
        ...
        <TouchableWithoutFeedback
          onPress={() => {
            this.state.isPlaying === "Done"
              ? this.props.navigation.navigate("Exercice_12_Aha_1")
              : null;
          }}
          //{this.renderPlayerIcon()}
        >
          <View style={{ flex: 1 }}>
            <Text style={styles.sub_header_audio}>Inner Scientist</Text>
            ...
            <View style={{ flex: 1, justifyContent: "center" }}>
              ...
              >
                <TouchableOpacity
                  ...
                  disabled={
                    this.state.isLoading || this.state.isPlaying === "Done"
                  }
                >
