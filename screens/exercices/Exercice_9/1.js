...
export default class Exercice_9_1 extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <View style={styles.container}>
        <TouchableWithoutFeedback
          onPress={() => {
            this.state.isPlaying === "Done" ? (this.props.navigation.navigate("Exercice_9_2")) : (null)
          }}
          //{this.renderPlayerIcon()}
        >
          <View>
            <Text style={styles.sub_header_left}>Exploring Values</Text>
            <TouchableOpacity
