...
class MFSU_Screen_PM5 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show_1: true,
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU01_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU01_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU01_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU01_D20/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU02_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU02_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU02_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU02_D20/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU03_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU03_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU03_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU03_D20/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU04_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU04_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU04_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU04_D20/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU05_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU05_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU05_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU05_D20/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU06_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU06_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU06_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU06_D20/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"MFSU07_D20/3"} />
                <Radio iconName={"lens"} label={"4"} value={"MFSU07_D20/4"} />
                <Radio iconName={"lens"} label={"5"} value={"MFSU07_D20/5"} />
                <Radio iconName={"lens"} label={"6"} value={"MFSU07_D20/6"} />
              </RadioGroup>
            </View>
...
export default connect(mapStateToProps)(MFSU_Screen_PM5);
