...
import { Update_Value3_D9 } from "../../../redux-persist/redux/user_values";
...
class Exercice_9_7 extends React.Component {
  constructor(props) {
    super(props);

    this.state = {
      newSelect: "",
      Value3_D9: this.props.user_values.Value3_D9 || ""
    };
  }
  ...
  handleSubmit = () => {
    ...
    this.props.dispatch(Update_Value3_D9(this.state.Value3_D9));
    this.props.navigation.navigate("Exercice_9_8");
  };
                ...
                <TagSelect
                  ...
                  onItemPress={() => {
                    if (this.tag.totalSelected === 1) {
                      ...
                      this.setState({ Value3_D9: Value3[0] });
                    } else {
