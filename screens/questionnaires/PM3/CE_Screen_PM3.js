...
export default class SE_Screen_PM3 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show_1: true,
  ...
  handleChange = AltNoAvail_D12 => {
    this.setState({ AltNoAvail_D12 });
  };
  ...
  handleClick = () => {
    ...
    firebase
      ...
      .ref("questionnaires")
      .child(uid)
      .update({ AltNoAvail_D12: this.state.AltNoAvail_D12 })
      .then(() => {});
          ...
          {this.state.show_1 ? (
            <>
              ...
              <View style={styles.question}>
                ...
                >
                  <Radio iconName={"lens"} label={"1"} value={"SE01_D12/1"} />
                  <Radio iconName={"lens"} label={"2"} value={"SE01_D12/2"} />
                  <Radio iconName={"lens"} label={"3"} value={"SE01_D12/3"} />
                  <Radio iconName={"lens"} label={"4"} value={"SE01_D12/4"} />
                  <Radio iconName={"lens"} label={"5"} value={"SE01_D12/5"} />
                  <Radio iconName={"lens"} label={"6"} value={"SE01_D12/6"} />
                </RadioGroup>
              </View>
            </>
          ) : null}
            ...
            <>
              ...
              <View style={styles.question}>
                <RadioGroup
                  ...
                  labelRight="Exactly true"
                >
                  <Radio iconName={"lens"} label={"1"} value={"SE02_D12/1"} />
                  <Radio iconName={"lens"} label={"2"} value={"SE02_D12/2"} />
                  <Radio iconName={"lens"} label={"3"} value={"SE02_D12/3"} />
                  <Radio iconName={"lens"} label={"4"} value={"SE02_D12/4"} />
                  <Radio iconName={"lens"} label={"5"} value={"SE02_D12/5"} />
                  <Radio iconName={"lens"} label={"6"} value={"SE02_D12/6"} />
                </RadioGroup>
              </View>
            </>
          ) : null}
            ...
            <>
              ...
              <View style={styles.question}>
                <RadioGroup
                  ...
                  labelRight="Exactly true"
                >
                  <Radio iconName={"lens"} label={"1"} value={"SE03_D12/1"} />
                  <Radio iconName={"lens"} label={"2"} value={"SE03_D12/2"} />
                  <Radio iconName={"lens"} label={"3"} value={"SE03_D12/3"} />
                  <Radio iconName={"lens"} label={"4"} value={"SE03_D12/4"} />
                  <Radio iconName={"lens"} label={"5"} value={"SE03_D12/5"} />
                  <Radio iconName={"lens"} label={"6"} value={"SE03_D12/6"} />
                </RadioGroup>
              </View>
            </>
          ) : null}
