            ...
            >
              <View style={{ flex: 1 }}>
                ...
                {this.state.show_6 ? (
                  <>
                    <Text style={styles.text}>
                      How likely is it that you recommend the 21-days program to
                      a friend or colleague? Assuming that the 21-days program
                      could be purchased as an app.
                    </Text>
                ...
                {this.state.show_10 ? (
                  <>
                    ...
                    <Text style={styles.text_small_QQ}>
                      For example App, Online video course, Offline workshop in
                      a group, Offline workshop with a coach, Book etc.
                    </Text>
