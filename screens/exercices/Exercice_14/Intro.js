...
class Exercice_14_Intro extends React.Component {
  constructor(props) {
    super(props);
          ...
          <View style={styles.container_scroll_img_absolute}>
            ...
            <View style={styles.middle}>
              ...
              <Text style={styles.intro_text_light}>
                {"\n"}6 MIN{"\n"}In this exercise, you will discover how to make
                your plans even stronger.
              </Text>
            </View>
          </View>
        </ScrollView>
          ...
          >
            ...
            >
              ...
              >
                ...
                Find out what should be your new meaningful smartphone habit. It’s cool, promised. Enjoy!
                </Text>
                <ExerciceButton
                  onPress={() => {
                    {
                ...
                >
                  <Text style={styles.styleText}>
                    day 13 - Meaningful Smartphone Habits
                  </Text>
                  <Image
...
export default connect(mapStateToProps)(Exercice_14_Intro);
