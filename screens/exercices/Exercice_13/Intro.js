...
export default class Exercice_13_Intro extends React.Component {
  constructor(props) {
    super(props);
        ...
        <ScrollView>
          <View style={styles.container_scroll_img_absolute}>
            ...
            <View style={styles.middle}>
              ...
              <Text style={styles.intro_header_light}>Meaningful Smartphone Habits</Text>

              <Text style={styles.intro_text_light}>
                {"\n"}5 MIN{"\n"}In this exercise, you will discover how to make good plans.
              </Text>
            </View>
          </View>
        </ScrollView>
