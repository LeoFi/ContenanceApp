...
class SUE_Screen_PM4 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show_1: true,
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"SUE01_D16/3"} />
                <Radio iconName={"lens"} label={"4"} value={"SUE01_D16/4"} />
                <Radio iconName={"lens"} label={"5"} value={"SUE01_D16/5"} />
                <Radio iconName={"lens"} label={"6"} value={"SUE01_D16/6"} />
              </RadioGroup>
            </View>
          </>
        ) : null}
          ...
          <>
            ...
            <View style={styles.question}>
              ...
              >
                ...
                <Radio iconName={"lens"} label={"3"} value={"SUE02_D16/3"} />
                <Radio iconName={"lens"} label={"4"} value={"SUE02_D16/4"} />
                <Radio iconName={"lens"} label={"5"} value={"SUE02_D16/5"} />
                <Radio iconName={"lens"} label={"6"} value={"SUE02_D16/6"} />
              </RadioGroup>
            </View>
...
export default connect(mapStateToProps)(SUE_Screen_PM4);
