  ...
  getChecked = value => {
    ...
    setTimeout(() => {
      if (this.state.show_1 == true) {
        ...
        this.setState({ progressValue: 8 });
        //this.props.dispatch(Update_Progress_T1(progressValue));
      } else if (this.state.show_9 == true) {
        this.setState({ progressValue: 9 });
        //this.props.dispatch(Update_Progress_T1(progressValue));
