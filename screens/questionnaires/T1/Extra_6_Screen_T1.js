  ...
  getChecked = value => {
    ...
    setTimeout(() => {
      if (this.state.show_1 == true) {
        ...
        this.setState({ progressValueT1: 73 / 79 });
        ...
        this.setState({ progressValueT1: 75 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
        ...
        this.setState({ progressValueT1: 76 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
        ...
        this.setState({ progressValueT1: 77 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
        ...
        this.setState({ progressValueT1: 78 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
      } else if (this.state.show_7 == true) {
        this.setState({ progressValueT1: 79 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
