...
import { Update_NewHabitActivity1_D13 } from "./../../../redux-persist/redux/user_values";

class Exercice_13_3 extends React.Component {
  constructor(props) {
    super(props);

    this.state = {
      NewHabitActivity1_D13: this.props.user_values.NewHabitActivity1_D13 || "",
  ...
  handleSubmit = () => {
    ...
    firebase
      ...
      .update({
        NewHabitActivity1_D13: NewHabitActivity[0]
      });
    this.props.dispatch(
      Update_NewHabitActivity1_D13(this.state.NewHabitActivity1_D13)
    );
    this.props.navigation.navigate("Exercice_13_4");
  };
        ...
        >
          ...
          >
                ...
                <ScrollView>
                  ...
                  >
                    ...
                    <Text style={styles.intro_text_grey}>
                      E.g. If I am in the metro, then I will listen to a TED
                      talk on my smartphone.
                      {"\n"}
                      {"\n"}If I am lonely, then I will send my best friend a
                      thoughful message.
                    </Text>
                  </View>
                </ScrollView>
            ...
            <Text style={styles.intro_text}>
              {"\n"}If I am {this.props.user_values.NewHabitTrigger1_D13}, then
              I will...
            </Text>
...
export default connect(mapStateToProps)(Exercice_13_3);
