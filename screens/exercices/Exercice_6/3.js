        ...
        >
          ...
          >
            <Text style={styles.sub_header}>
              What did you feel like right before that unconscious reach for the
              smartphone?
            </Text>
            <Text style={styles.text}>
              {"\n"}Please choose 3 emotions from the list that might trigger
              you emotionally to use your smartphone. We know, we know, it might
              be more than 3 but let’s start small here.
            </Text>
