...
import { Update_NewHabitActivity3_D13 } from "./../../../redux-persist/redux/user_values";
...
class Exercice_13_5 extends React.Component {
  ...
  handleSubmit = () => {
    ...
    this.props.dispatch(
      Update_NewHabitActivity3_D13(this.state.NewHabitActivity3_D13)
    );
        ...
        >
          ...
          >
            ...
            <Text style={styles.intro_text}>
              {"\n"}If I am {this.props.user_values.NewHabitTrigger3_D13}, then
              I will...
            </Text>
