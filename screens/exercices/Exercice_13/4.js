...
class Exercice_13_4 extends React.Component {
  ...
  handleSubmit = () => {
    ...
    this.props.dispatch(Update_NewHabitActivity2_D13(this.state.NewHabitActivity2_D13));
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              <View style={styles.container_scroll}>
                ...
                <Text style={styles.intro_text}>{"\n"}If I am {this.props.user_values.NewHabitTrigger2_D13}, then I will...</Text>
                  ...
                  onItemPress={() => {
                    if (this.tag.totalSelected === 1) {
                      let NewHabitActivity = [];
                          ...
                          this.setState({ NewHabitActivity2_D13: NewHabitActivity[0] });
                    } else {
