...
class CompletedChallengesScreen extends React.Component {
  state = {
    modalVisible: false
  };
  ...
  render() {
    ...
    const challengeDone = challenge.filter(item => item.state === "DONE");
    ...
    return (
      ...
      >
        ...
        >
            ...
            <View key={key}>
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() => {
                    this.setState({textContent: item.text_content, color: item.lightColor});
                ...
                >
                  ...
                  >
                    <Svg width="33" height="33" viewBox="0 0 33 33" fill="none">
                      <Circle cx="16.5" cy="16.5" r="15.75" fill={item.color} />
                      <Path
          ...
          {challengeCompleted.length && challengeDone.length < 20 ? (
            <Text
              style={{
                color: "#2C3B51",
                fontSize: 19,
...
export default connect(mapStateToProps)(CompletedChallengesScreen);
