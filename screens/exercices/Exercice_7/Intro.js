...
export default class Exercice_7_Intro extends React.Component {
  constructor(props) {
    super(props);
      ...
      <View style={styles.background_intro}>
        ...
        <ScrollView>
          <View style={styles.container_scroll_img_absolute}>
            ...
            <View style={styles.middle}>
              <Text style={styles.intro_header_day_light}>Day 7</Text>
        ...
        <View style={styles.bottom}>
          <PrimaryButton
            ...
            onPress={() => {
              this.props.navigation.navigate("Exercice_7_1");
            }}
          />
        </View>
      </View>
