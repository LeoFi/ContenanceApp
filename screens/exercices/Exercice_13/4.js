...
import { Update_NewHabitActivity2_D13 } from "./../../../redux-persist/redux/user_values";

class Exercice_13_4 extends React.Component {
  constructor(props) {
    super(props);

    this.state = {
      NewHabitActivity2_D13: this.props.user_values.NewHabitActivity2_D13 || "",
  ...
  handleSubmit = () => {
    ...
    firebase
      ...
      .update({
        NewHabitActivity2_D13: NewHabitActivity[0]
      });
    this.props.dispatch(
      Update_NewHabitActivity2_D13(this.state.NewHabitActivity2_D13)
    );
    this.props.navigation.navigate("Exercice_13_5");
  };
        ...
        >
          ...
          >
                ...
                <ScrollView>
                  ...
                  >
                    ...
                    <Text style={styles.intro_text_grey}>
                      E.g. ... then I will listen to a TED talk on my
                      smartphone.
                      {"\n"}
                      {"\n"}...then I will send my best friend a thoughful
                      message.
                    </Text>
                  </View>
                </ScrollView>
            ...
            <Text style={styles.intro_text}>
              {"\n"}If I am {this.props.user_values.NewHabitTrigger2_D13}, then
              I will...
            </Text>
...
export default connect(mapStateToProps)(Exercice_13_4);
