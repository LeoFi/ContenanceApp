...
export default class Exercice_11_6 extends React.Component {
  constructor(props) {
    super(props);
          ...
          <View style={styles.container_scroll}>
            ...
            >
              ...
              <Text style={styles.intro_text}>
                {"\n"}This one might be hard if you are not in a stimulating
                environment, but there might be more than you think.{"\n"}
                {"\n"}Maybe it’s your coffee, your laundry detergent or your
                skin.
              </Text>
            </View>
          </View>
