  ...
  getChecked = value => {
    ...
    setTimeout(() => {
      if (this.state.show_1 == true) {
        ...
        this.setState({ progressValueT1: 53 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
      } else if (this.state.show_2 == true) {
        this.setState({ show_1: false });
        this.setState({ show_2: false });
        this.setState({ show_3: true });
        this.setState({ progressValueT1: 54 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
        ...
        this.setState({ progressValueT1: 55 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
        ...
        this.setState({ progressValueT1: 56 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
      } else if (this.state.show_5 == true) {
        this.setState({ progressValueT1: 57 / 79 });
        this.props.dispatch(Update_Progress_T1(progressValueT1));
