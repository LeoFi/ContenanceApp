...
class TRP_Screen_T1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show_1: true,
          ...
          {this.state.show_1 ? (
            <>
              <Text style={styles.text_left}>
                Smartphones increased the speed of responses people expected
                from me.
              </Text>
...
export default connect(mapStateToProps)(TRP_Screen_T1);
