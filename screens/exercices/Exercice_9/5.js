...
class Exercice_9_5 extends React.Component {
  constructor(props) {
    super(props);

    this.state = {
      newSelect: "",
      Value1_D9: this.props.user_values.Value1_D9 || ""
    };
  }
  ...
  handleSubmit = () => {
    ...
    for (const prop in this.tag.itemsSelected) {
      Value1.push(this.tag.itemsSelected[prop]);
    }
...
export default connect(mapStateToProps)(Exercice_9_5);
